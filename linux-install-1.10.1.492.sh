...
curl -O https://download.clojure.org/install/clojure-tools-1.10.1.492.tar.gz
...
install -Dm644 clojure-tools/clojure-tools-1.10.1.492.jar "$clojure_lib_dir/libexec/clojure-tools-1.10.1.492.jar"
